...
def get_dashboard_data():
    try:
        ...
        benchmark_data = bench.to_dict('records')
        
        # Données pour les graphiques
        chart_data = {
            "companies": df_display['source_file'].unique().tolist(),
            "confidence_distribution": df_display['confidence'].value_counts().to_dict() if 'confidence' in df_display.columns else {}
        }
